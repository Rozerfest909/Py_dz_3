...
N = input('Введите eng, если играем в английской раскладке. Введите русс, если в русской: ')
word = input('Введите слово: ').upper()
if N == "eng":
	print('Стоимость введеного слова > ', sum([k for i in word for k, j in eng.items() if i in j]), 'очков')
elif N == "русс":
	print('Стоимость введеного слова > ', sum([k for i in word for k, j in russ.items() if i in j]), 'очков')
else:
    print('Вы ввели не то. Попробуйте с самого начала')